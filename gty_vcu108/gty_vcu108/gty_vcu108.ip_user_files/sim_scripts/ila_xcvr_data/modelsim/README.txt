...
#
# Generated by export_simulation on Sun Oct 18 20:10:20 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ila_xcvr_data.sh' script.

./ila_xcvr_data.sh -reset_run
...
./ila_xcvr_data.sh -noclean_files

For more information on the script, please type './ila_xcvr_data.sh -help'.
