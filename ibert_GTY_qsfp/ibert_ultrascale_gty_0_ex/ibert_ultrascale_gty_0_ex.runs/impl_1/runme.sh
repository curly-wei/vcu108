...
EAStep vivado -log example_ibert_ultrascale_gty_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_ibert_ultrascale_gty_0.tcl -notrace
